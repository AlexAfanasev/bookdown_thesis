...
<!-- add further comments on figures -->
<!-- At the end: -->

Table ... summarizes the estimation results for all models 
...
Table ... summarizes the model comparison results for all models 
```{r, eval=FALSE, include=FALSE}
# columns num params, lik, BIC, DIC, AIC
# rows Models
rownames(result_table) <- c(
  "$\\tilde{\\eta}_t$", "$cr_t$", "$my_t$", "$fr_t$", "$ms_t$", "$gdp_t$",
  "$\\Delta\\tilde{\\eta}_t$", "$\\Delta cr_t$", "$\\Delta my_t$", "$\\Delta^2 my_t$",
