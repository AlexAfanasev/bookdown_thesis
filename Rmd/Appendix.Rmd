...
# beta_0
df <- data.frame(time = 1:nrow(traces), beta_0 = traces[, 7])
p1 <- ggplot(data = df, aes(x = beta_0)) +
  geom_density(aes(x = beta_0, colour = "Posterior", linetype = "Posterior"), 
               show.legend = FALSE) + 
  geom_vline(
...
# beta_1
df <- data.frame(time = 1:nrow(traces), beta_1 = traces[, 8])
p2 <- ggplot(data = df, aes(x = beta_1)) +
  geom_density(aes(x = beta_1, colour = "Posterior", linetype = "Posterior"), 
               show.legend = FALSE) + 
  geom_vline(
...
# beta_2
df <- data.frame(time = 1:nrow(traces), beta_2 = traces[, 9])
p3 <- ggplot(data = df, aes(x = beta_2)) +
  geom_density(aes(x = beta_2, colour = "Posterior", linetype = "Posterior"), 
               show.legend = FALSE) + 
  geom_vline(
...
# beta_3
df <- data.frame(time = 1:nrow(traces), beta_3 = traces[, 10])
p4 <- ggplot(data = df, aes(x = beta_3)) +
  geom_density(aes(x = beta_3, colour = "Posterior", linetype = "Posterior"), 
               show.legend = FALSE) + 
  geom_vline(
...
# beta_4
df <- data.frame(time = 1:nrow(traces), beta_4 = traces[, 11])
p5 <- ggplot(data = df, aes(x = beta_4)) +
  geom_density(aes(x = beta_4, colour = "Posterior", linetype = "Posterior"), 
               show.legend = FALSE) + 
  geom_vline(
...
# beta_5
df <- data.frame(time = 1:nrow(traces), beta_5 = traces[, 12])
p6 <- ggplot(data = df, aes(x = beta_5)) +
  geom_density(aes(x = beta_5, colour = "Posterior", linetype = "Posterior"), 
               show.legend = FALSE) + 
  geom_vline(
    aes(xintercept = mean(traces[, 12]), 
        colour = "Posterior Mean", linetype = "Posterior Mean"), 
    show.legend = FALSE
  ) +
  stat_function(
...
# sigma_u
df <- data.frame(time = 1:nrow(traces), sigma_u = exp(traces[, 5]))
p7 <- ggplot(data = df, aes(x = sigma_u)) +
  geom_density(aes(x = sigma_u, colour = "Posterior", linetype = "Posterior"), 
               show.legend = FALSE) + 
  geom_vline(
    aes(xintercept = mean(exp(traces[, 5])), 
        colour = "Posterior Mean", linetype = "Posterior Mean"), 
    show.legend = FALSE
  ) +
  stat_function(
...
# sigma_epsilon
df <- data.frame(time = 1:nrow(traces), sigma_e = exp(traces[, 4]))
p8 <- ggplot(data = df, aes(x = sigma_e)) +
  geom_density(aes(x = sigma_e, colour = "Posterior", linetype = "Posterior"), 
               show.legend = FALSE) + 
  geom_vline(
...
# phi
df <- data.frame(time = 1:nrow(traces), phi = tanh(traces[, 6]))
p9 <- ggplot(data = df, aes(x = phi)) +
  geom_density(aes(x = phi, colour = "Posterior", linetype = "Posterior"), 
               show.legend = FALSE) + 
  geom_vline(
    aes(xintercept = mean(tanh(traces[, 6])), 
        colour = "Posterior Mean", linetype = "Posterior Mean"), 
    show.legend = FALSE
  ) +
  stat_function(
...
```{r, extension-ardl-model-marginal-density, eval=FALSE, echo=FALSE, fig.align='center', fig.cap="Random walk state model: Gaussian kernel density estimates of the marginal posterior distributions", fig.width=6, fig.height=8.5, warning=FALSE}
traces <- rbind(
  result[[1]]@traces, 
  result[[2]]@traces, 
  result[[3]]@traces
