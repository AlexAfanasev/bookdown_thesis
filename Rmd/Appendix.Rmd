...
```{r, extension-static-model-trace, eval=TRUE, echo=FALSE, fig.align='center', fig.cap="Covariate extension: PMMH trace plot", fig.width=6, fig.height=6.75, warning=FALSE}
traces <- list(
  result[[1]]@traces[10000:50000, ], 
  result[[2]]@traces[10000:50000, ],
  result[[3]]@traces[10000:50000, ]
