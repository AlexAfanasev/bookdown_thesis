...
\end{equation}
where $g_{\theta}(y_{n}|x_{n})$ represents the conditional marginal density [@doucet_inference, p. 328].
...
\end{split}
\end{equation}
Given that parameter inference is the main goal, the focus will be on the marginal likelihood in Equation \@ref(eq:pomp-likelihood), referred to as likelihood in the following.
