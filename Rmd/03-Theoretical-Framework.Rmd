...
A naive approach for estimating the likelihood function \@ref(eq:pomp-likelihood) using Monte Carlo integration can be based upon the Markov property, as presented in the \texttt{pomp} documentation [@king_pomp]
\begin{equation*}
\begin{split}
