...
```{r, source_basic_functions, include=FALSE}
...
```{r, helper_nonlinear_simulation, include = FALSE}
...
```{r, setup_nonlinear_simulation, include = FALSE}
N_obs <- 76
N_sim <- 4
true_params_simulation <- list(
    beta_1 = 0.8,
    beta_2 = 0.2,
    sigma_e = log(0.05),
    sigma_u = log(0.025)
...
```{r, nonlinear_simulation, include = FALSE}
...
\begin{center}
 \begin{tabular}{|c c c |} 
 \hline
 Parameter & True Value & Start Values \\ [0.5ex] 
 \hline
 $\beta_{1}$ & `r true_params_simulation$beta_1` & `r params_simulation$beta_1` \\
 \hline
 $\beta_{2}$ & `r true_params_simulation$beta_2` & `r params_simulation$beta_2` \\
 \hline
 $\sigma_{e}$ & `r exp(true_params_simulation$sigma_e)` & `r exp(params_simulation$sigma_e)` \\
 \hline
 $\sigma_{u}$ & `r exp(true_params_simulation$sigma_u)` & `r exp(params_simulation$sigma_u)` \\
 \hline
 \end{tabular}
\end{center}
