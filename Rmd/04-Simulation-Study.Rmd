...
```{r, sim-4-plot-1, eval=TRUE, echo=FALSE, fig.align='center', fig.cap="Exemplary simulation: Simulated state and observation processes", fig.width=5, fig.height=2, warning=FALSE}
library(ggplot2)
